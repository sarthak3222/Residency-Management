...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>24 CARAT RESIDENCY USER</title>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
												...
												<h2 style ="color:Silver;text-align:center;">USER LOGIN</h2>
                        ...
                        <asp:Button ID="btnlogin" runat="server" class="btn btn-success" Text="LOGIN" 
                                style="background-color: #5cb85c;border-color: #fff; color:White;"/>
										...
										<div class="toolbar clearfix">
											...
											<div>
                                                <asp:HyperLink ID="hlregistration" runat="server" class="user-signup-link" NavigateUrl="~/user/registration.aspx" >I Want To Register<i class="ace-icon fa fa-arrow-right"></i></asp:HyperLink>
																</div>
										</div>
									</div><!-- /.widget-body -->
								</div><!-- /.login-box -->
